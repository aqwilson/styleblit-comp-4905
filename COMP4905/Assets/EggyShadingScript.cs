...
public class EggyShadingScript : MonoBehaviour
{
    Texture2D tex;

    public GameObject eggy;
    public Mesh eggyMesh;
    Mesh sphereMesh;
    GameObject sphere;
    ...
    void Start()
    {
        ...
        eggy = GameObject.Find("Eggy 1");
        eggyMesh = eggy.GetComponent<SkinnedMeshRenderer>().sharedMesh;

        Vector3[] verts = eggyMesh.vertices;
        List<Vector3> reducedVerts = new List<Vector3>();
        List<Vector3> xyOnlyComparison = new List<Vector3>();
        Vector3[] normals = eggyMesh.normals;
        List<Vector3> reducedNormals = new List<Vector3>();
        List<Vector3> xyComparedNormals = new List<Vector3>();

        int[] triangles = eggyMesh.triangles;
        ...
        // EXTRA SETTING
        GameObject r = GameObject.Find("Eggy 1");
        eggy = r;
